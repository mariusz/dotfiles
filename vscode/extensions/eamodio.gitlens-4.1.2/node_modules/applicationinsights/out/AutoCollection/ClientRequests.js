...
var AutoCollectClientRequests = (function () {
    ...
    AutoCollectClientRequests.trackRequest = function (client, requestOptions, request, properties) {
        ...
        var uniqueRequestId = currentContext && currentContext.operation && (currentContext.operation.parentId + AutoCollectClientRequests.requestNumber++ + '.');
...
AutoCollectClientRequests.requestNumber = 1;
