    ...
    provideAnnotation(shaOrLine) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const l of blame.lines) {
                ...
                const hover = annotations_1.Annotations.hover(commit, renderOptions, cfg.heatmap.enabled, dateFormat);
                const endIndex = cfg.wholeLine ? annotations_1.endOfLineIndex : this.editor.document.lineAt(line).firstNonWhitespaceCharacterIndex;
                hover.range = this.editor.document.validateRange(new vscode_1.Range(line, 0, line, endIndex));
