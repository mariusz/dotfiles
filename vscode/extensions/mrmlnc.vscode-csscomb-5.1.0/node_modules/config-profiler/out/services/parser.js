...
function getPackageProperty(config, options) {
	return config[options.props.package] || null;
}
...
function parse(content, filepath, ctime, options) {
	...
	// console.log(config, filepath, options.props, isPackageFile(filepath, config, options), getPackageProperty(config, options))
